...
def test_merge_sort_main(n, expected):
    assert merge_sort(n) == expected

def test_merge_sort_random(random_list):
    assert merge_sort(random_list) == list(sorted(random_list))
...
def test_merge_sort_multiple(n, expected):
    assert merge_sort(n) == expected
